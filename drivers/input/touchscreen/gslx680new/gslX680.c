...
unsigned int *gslX680_config_data[] = {
	...
	gsl_config_data_id_3676_1280x800,
...
static void gsl_ts_init_work(struct work_struct *work)
{
	int ret;
...
static int __init gsl_ts_init(void)
{
	...
	INIT_WORK(&init_work, gsl_ts_init_work);
	queue_work(gslX680_wq, &init_work);
