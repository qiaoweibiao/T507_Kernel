...
{
	vin_reg_clr_set(cmb_csi_base_addr[sel] + CMB_PHY_TOP_REG_OFF,
		CMB_PHY_VREF_OP9_MASK, en << CMB_PHY_VREF_OP9);
}
...
{
	vin_reg_writel(cmb_csi_base_addr[sel] + CMB_PHY_TRES_REG_OFF, 0x000a00af);
}

void cmb_phy_trescal_disble(unsigned int sel)
{
	vin_reg_clr_set(cmb_csi_base_addr[sel] + CMB_PHY_TRES_REG_OFF,
		CMB_PHY_TRES_SOFT_MASK, 0 << CMB_PHY_TRES_SOFT);
}

void cmb_phy_set_trescal(unsigned int sel, unsigned int en)
{
	vin_reg_clr_set(cmb_csi_base_addr[sel] + CMB_PHY_TRES_REG_OFF,
		CMB_PHY_TRES_SET, en << CMB_PHY_TRES_SET);
}
...
{
	vin_reg_clr_set(cmb_csi_base_addr[sel] + CMB_PHY_CTL_REG_OFF,
		CMB_PHY0_LP_PEFI_MASK, en << CMB_PHY0_LP_PEFI);
}

void CMB_PHY0_HS_REFI(unsigned int sel, unsigned int en)
{
	vin_reg_clr_set(cmb_csi_base_addr[sel] + CMB_PHY_CTL_REG_OFF,
		CMB_PHY0_HS_PEFI_MASK, en << CMB_PHY0_HS_PEFI);
}

void cmb_phy_lane_num_enable(unsigned int sel, unsigned int lanedt)
{
	vin_reg_clr_set(cmb_csi_base_addr[sel] + CMB_PHY_CTL_REG_OFF,
		CMB_PHY_LANEDT_EN_MASK, lanedt << CMB_PHY_LANEDT_EN);
	vin_reg_clr_set(cmb_csi_base_addr[sel] + CMB_PHY_CTL_REG_OFF,
...
{
	vin_reg_clr_set(cmb_csi_base_addr[sel] + CMB_PHY_CTL_REG_OFF,
		CMB_PHY_LINK_MODE_MASK, 0xf << CMB_PHY_LINK_MODE);
}
...
{
	vin_reg_clr_set(cmb_csi_base_addr[sel] + CMB_PHY_CTL_REG_OFF + CMB_PHYREG_PHYB_OFF,
		CMB_PHY0_EN_MASK, en << CMB_PHY0_EN);
}
...
{
	vin_reg_clr_set(cmb_csi_base_addr[sel] + CMB_PHY_OFS_REG_OFF,
		CMB_PHY_OFS_DT_AUTO_MASK, data << CMB_PHY_OFS_DT_AUTO);
}

void cmb_phy0_OFS0_SOFT(unsigned int sel, unsigned int en)
{
	vin_reg_clr_set(cmb_csi_base_addr[sel] + CMB_PHY_OFS_REG_OFF,
		CMB_PHY_OFS_DT_SOFT_MASK, en << CMB_PHY_OFS_DT_SOFT);
}

void cmb_phy0_OFS1(unsigned int sel, unsigned int data)
{
	vin_reg_clr_set(cmb_csi_base_addr[sel] + CMB_PHY_OFS_REG1_OFF,
		CMB_PHY_OFS_REG1_MASK, data << CMB_PHY_OFS_REG1);
}

void cmb_phy0_OFS0_AUTO_PHYB(unsigned int sel, unsigned int data)
{
	vin_reg_clr_set(cmb_csi_base_addr[sel] + CMB_PHY_OFS_REG_OFF + CMB_PHYREG_PHYB_OFF,
		CMB_PHY_OFS_DT_AUTO_MASK, data << CMB_PHY_OFS_DT_AUTO);
}
...
{
	vin_reg_clr_set(cmb_csi_base_addr[sel] + CMB_PHY_OFS_REG1_OFF + CMB_PHYREG_PHYB_OFF,
		CMB_PHY_OFS_REG1_MASK, data << CMB_PHY_OFS_REG1);
}
...
{
	vin_reg_clr_set(cmb_csi_base_addr[sel] + CMB_PHY_TERM_CTL_REG_OFF + CMB_PHYREG_PHYB_OFF,
		CMB_PHY0_TERM_EN_DLY_MASK, dly << CMB_PHY0_TERM_EN_DLY);
}
...
{
	vin_reg_clr_set(cmb_csi_base_addr[sel] + CMB_PHY_HS_CTL_REG_OFF + CMB_PHYREG_PHYB_OFF,
		CMB_PHY0_HS_DLY_MASK, dly << CMB_PHY0_HS_DLY);
}
...
{
	vin_reg_clr_set(cmb_csi_base_addr[sel] + CMB_PHY_S2P_CTL_REG_OFF + CMB_PHYREG_PHYB_OFF,
...
void cmb_phy_mipi_lpnum_enable(unsigned int sel, unsigned int lane)
{
	vin_reg_clr_set(cmb_csi_base_addr[sel] + CMB_PHY_MIPIRX_CTL_REG_OFF,
		CMB_PHY_MIPI_MPDT_EN_MASK, lane << CMB_PHY_MIPI_MPDT_EN);
	vin_reg_clr_set(cmb_csi_base_addr[sel] + CMB_PHY_MIPIRX_CTL_REG_OFF,
...
{
	vin_reg_clr_set(cmb_csi_base_addr[sel] + CMB_PHY_MIPIRX_CTL_REG_OFF,
		CMB_PHY0_MIPIHS_SYNC_MODE_MASK, en << CMB_PHY0_MIPIHS_SYNC_MODE);
}

void cmb_phy_mipi_lpnum_enable_PHYB(unsigned int sel, unsigned int lane)
{
	vin_reg_clr_set(cmb_csi_base_addr[sel] + CMB_PHY_MIPIRX_CTL_REG_OFF + CMB_PHYREG_PHYB_OFF,
		CMB_PHY_MIPI_MPDT_EN_MASK, lane << CMB_PHY_MIPI_MPDT_EN);
	vin_reg_clr_set(cmb_csi_base_addr[sel] + CMB_PHY_MIPIRX_CTL_REG_OFF + CMB_PHYREG_PHYB_OFF,
		CMB_PHY_MIPI_LPCK_EN_MASK, 0x1 << CMB_PHY_MIPI_LPCK_EN);
}
...
{
	vin_reg_clr_set(cmb_csi_base_addr[sel] + CMB_PHY0_INI_PD_REG_OFF,
		CMB_PHY0_INI_PD_SOTDET_PD_MASK, en << CMB_PHY0_INI_PD_SOTDET_PD);
}

void cmb_phy0_SET_INI_PD_PHYB(unsigned int sel, unsigned int en)
{
	vin_reg_clr_set(cmb_csi_base_addr[sel] + CMB_PHY0_INI_PD_REG_OFF + CMB_PHYREG_PHYB_OFF,
		CMB_PHY0_INI_PD_SOTDET_PD_MASK, en << CMB_PHY0_INI_PD_SOTDET_PD);
}
...
{
	vin_reg_clr_set(cmb_csi_base_addr[sel] + CMB_PORT_CTL_REG_OFF + CMB_PORT1_REG_OFF,
		CMB_PORT_EN_MASK, 1 << CMB_PORT_EN);
}
...
{
	vin_reg_clr_set(cmb_csi_base_addr[sel] + CMB_PORT_CTL_REG_OFF,
		CMB_PORT_CHANNEL_NUM_MASK, num << CMB_PORT_CHANNEL_NUM);
}
...
{
	vin_reg_clr_set(cmb_csi_base_addr[sel] + CMB_PORT_LANE_MAP_REG0_OFF + CMB_PORT1_REG_OFF,
		CMB_PORT_LANE0_ID_MASK, 0x4 << CMB_PORT_LANE0_ID);
	vin_reg_clr_set(cmb_csi_base_addr[sel] + CMB_PORT_LANE_MAP_REG0_OFF + CMB_PORT1_REG_OFF,
		CMB_PORT_LANE1_ID_MASK, 0x5 << CMB_PORT_LANE1_ID);
}

void cmb_port1_mipi_enpack_enable(unsigned int sel)
{
	vin_reg_clr_set(cmb_csi_base_addr[sel] + CMB_PORT_MIPI_CFG_REG_OFF + CMB_PORT1_REG_OFF,
...
{
	vin_reg_clr_set(cmb_csi_base_addr[sel] + CMB_PORT_MIPI_DI_TRIG_REG_OFF + CMB_PORT1_REG_OFF,
		CMB_MIPI_FS_MASK, en << CMB_MIPI_FS);
	vin_reg_clr_set(cmb_csi_base_addr[sel] + CMB_PORT_MIPI_DI_TRIG_REG_OFF + CMB_PORT1_REG_OFF,
		CMB_MIPI_FE_MASK, en << CMB_MIPI_FE);
	vin_reg_clr_set(cmb_csi_base_addr[sel] + CMB_PORT_MIPI_DI_TRIG_REG_OFF + CMB_PORT1_REG_OFF,
