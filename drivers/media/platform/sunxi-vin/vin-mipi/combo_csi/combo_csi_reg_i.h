 ...
 */
#define CMB_PHYREG_PHYB_OFF			0x100
...
#define CMB_PHY_TRES_REG_OFF			0x004
#define CMB_PHY_TRES_SOFT				1
#define CMB_PHY_TRES_SOFT_MASK			(0x1 << CMB_PHY_TRES_SOFT)
#define CMB_PHY_TRES_SET				4
#define CMB_PHY_TRES_SET_MASK			(0x1f << CMB_PHY_TRES_SOFT)
...
#define CMB_PHY_OFS_REG_OFF			0x108
#define CMB_PHY_OFS_DT_AUTO			4
#define CMB_PHY_OFS_DT_AUTO_MASK	(0x0f << CMB_PHY_OFS_DT_AUTO)
#define CMB_PHY_OFS_DT_SOFT			12
#define CMB_PHY_OFS_DT_SOFT_MASK	(0x0f << CMB_PHY_OFS_DT_SOFT)

#define CMB_PHY_OFS_REG1_OFF		0x10C
#define CMB_PHY_OFS_REG1			0
#define CMB_PHY_OFS_REG1_MASK		(0xffffffff << CMB_PHY_OFS_REG1)
...
#define CMB_PHY0_INI_PD_REG_OFF			0x184
#define CMB_PHY0_INI_PD_SOTDET_PD		0
#define CMB_PHY0_INI_PD_SOTDET_PD_MASK	(0xf << CMB_PHY0_INI_PD_SOTDET_PD)

/*
 * Detail information of registers----PORT0/1
 */
#define CMB_PORT1_REG_OFF			0x400
