...
defined(CONFIG_ARCH_SUN50IW6) || defined(CONFIG_ARCH_SUN8IW17)
...
#if defined(CONFIG_ARCH_SUN8IW11) || defined(CONFIG_ARCH_SUN8IW7) || \
defined(CONFIG_ARCH_SUN50IW1) || defined(CONFIG_ARCH_SUN8IW17)
#define DRQDST_HDMI_TX		DRQDST_DAUDIO_2_TX
#elif defined(CONFIG_ARCH_SUN8IW12) || defined(CONFIG_ARCH_SUN50IW6)
